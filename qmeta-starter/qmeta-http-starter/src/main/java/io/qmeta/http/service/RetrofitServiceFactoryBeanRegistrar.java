...
public class RetrofitServiceFactoryBeanRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    /**
     * Scans for interfaces annotated with {@link io.qmeta.http.annotation.RemoteService} from the packages defined by
    ...
    /**
     * Inspects the packages to be scanned for {@link io.qmeta.http.annotation.RemoteService} interfaces from the {@link RetrofitServiceScan}
     * import annotation.
     *
     * @param metadata the annotation metadata.
     * @return a set of packages to be scanned for {@link io.qmeta.http.annotation.RemoteService} candidates.
     */
    ...
    private String generateBeanName(BeanDefinition beanDefinition) {
        ...
        try {
            ...
            RemoteService retrofitService = beanClass.getAnnotation(RemoteService.class);
