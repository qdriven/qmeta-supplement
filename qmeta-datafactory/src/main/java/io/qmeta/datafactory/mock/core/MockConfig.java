...
import io.qmeta.datafactory.mock.mocker.*;
import io.qmeta.datafactory.mock.util.FieldMatchingResolver;
...
public class MockConfig {
  ...
  public MockConfig() {
    ...
    registerMocker((Mocker) BOOLEAN_MOCKER, boolean.class, Boolean.class);
